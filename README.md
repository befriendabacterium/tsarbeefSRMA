...
To run the code, clone/download this repository and open the RProject file ('beefantibiotics-SRMA.Rproj') in RStudio and the two main scripts which sourcel all other scripts in the repository:
